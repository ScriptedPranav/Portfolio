  ...
  return(
    <article className="home">
      <section className="home__content">
        ...
        <h2 className="home__name">Pranav Sinha.</h2>

        <h2 className="home__brief">I build stuff for the web.</h2>

        <h3 className="home__description">
          I am a Fullstack Developer with experience in building dynamic web pages and scalable NodeJs Applications. Currently Looking for a job.
        </h3>
